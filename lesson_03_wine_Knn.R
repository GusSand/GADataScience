...
## PREPROCESSING
data <- read.csv("wine.csv")               # create copy of wine data
labels <- data$Wine      # store labels
data$Wine <- NULL        # remove labels from feature set (note: could
maxN <- 100					# max number of iterations
